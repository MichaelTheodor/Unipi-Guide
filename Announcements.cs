...
namespace Unipi_Guide
{
    public partial class Announcements : Form
    {
        ...
        {
            richTextBox3.LoadFile("textfiles\\Ο Οικουμενικός Πατριάρχης τιμήθηκε από το Πανεπιστήμιο Πειραιώς.txt", RichTextBoxStreamType.PlainText);
        }

        private void button4_Click(object sender, EventArgs e)
        {

            richTextBox3.LoadFile("textfiles\\Τροποποίηση Ακαδημαϊκού Ημερολογίου ακαδ. έτους 2022-2023.txt", RichTextBoxStreamType.PlainText);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            richTextBox3.LoadFile("textfiles\\Ανακοίνωση για αναβληθείσεις εξετάσεις της Τετάρτης 21 Σεπτεμβρίου 2022.txt", RichTextBoxStreamType.PlainText);
        }

        private void button6_Click(object sender, EventArgs e)
        {
            richTextBox3.LoadFile("textfiles\\Ανακοίνωση για έναρξη μαθημάτων του χειμερινού εξαμήνου ακαδ. έτους 2022-23.txt", RichTextBoxStreamType.PlainText);
        }

        private void button7_Click(object sender, EventArgs e)
        {
            richTextBox3.LoadFile("textfiles\\Αναβολή εξετάσεων την Τετάρτη 21 Σεπτεμβρίου 2022.txt", RichTextBoxStreamType.PlainText);
        }
