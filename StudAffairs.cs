...
{
    public partial class StudAffairs : Form
    {
        ...
        {
            String filename = "_μετεγγραφών_2022-2023_.pdf";
        ...
        {
            String filename1= "_ημερολ._2022-23_-1η_αναθεώρηση_in.pdf";
            axAcroPDF1.LoadFile(filename1);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            String filename2 = "_Fulbright.pdf";
            axAcroPDF1.LoadFile(filename2);
        }

        private void button6_Click(object sender, EventArgs e)
        {
            String filename3 = "_Σλοβακίας_2022.pdf";
            axAcroPDF1.LoadFile(filename3);
        }

        private void button7_Click(object sender, EventArgs e)
        {
            String filename4 = "_Έτος_Νεολαίας.pdf";
            axAcroPDF1.LoadFile(filename4);
        }

        private void πρυτανικόΣυμβούλιοToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
