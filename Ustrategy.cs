...
{
    public partial class Ustrategy : Form
    {
        ...
        {
            String filename = " Α7_Στρατηγικός_Προγραμματισμός_του_Ιδρύματος.pdf";
        ...
        {
            String filename1 = "Α7_Στρατηγικός_Προγραμματισμός_του_Ιδρύματος.pdf";
