...
{
    public partial class Mrectcounsdecis : Form
    {
        private SoundPlayer _soundPlayer;
        public Mrectcounsdecis()
        {
            InitializeComponent();
        ...
        {
            String filename = "_Πρυτανικού_Συμβουλίου_συνεδρία_23η_31-8-2021.pdf";
            axAcroPDF1.LoadFile(filename);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            String filename1 = "_Πρυτανικού_Συμβουλίου_συνεδρία_22η__30-7-2021.pdf";
            axAcroPDF1.LoadFile(filename1);
        }

        private void button11_Click(object sender, EventArgs e)
        {
            String filename2 = "_Πρυτανικού_Συμβουλίου_συνεδρία_21η__23-7-2021.pdf";
            axAcroPDF1.LoadFile(filename2);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            String filename3 = "_Πρυτανικού_Συμβουλίου_συνεδρία_20η__13-7-2021.pdf";
