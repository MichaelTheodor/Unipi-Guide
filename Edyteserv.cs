...
{
    public partial class Edyteserv : Form
    {
        ...
        {
            richTextBox2.LoadFile("textfiles\\Ηλεκτρονική Υπηρεσία Απόκτησης Ακαδημαϊκής Ταυτότητας.txt", RichTextBoxStreamType.PlainText);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Ηλεκτρονική Υπηρεσία Ολοκληρωμένης Διαχείρισης Συγγραμμάτων (Εύδοξος).txt", RichTextBoxStreamType.PlainText);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Ευρυζωνική Διασύνδεση Φοιτητών (εύρυ-where).txt", RichTextBoxStreamType.PlainText);
        }

        private void button6_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Υπολογιστικό Νέφος της Εκπαίδευσης (~okeanos).txt", RichTextBoxStreamType.PlainText);
        }

        private void button7_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Υπηρεσία ViMa (Εικονικές Μηχανές) για τη φιλοξενία Υπηρεσιών, Πειραμάτων και Εφαρμογών.txt", RichTextBoxStreamType.PlainText);
        }

        private void button9_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Υπηρεσία online Αποθήκευσης Αρχείων (Pithos+).txt", RichTextBoxStreamType.PlainText);
        }

        private void button11_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Σύστημα Κεντρικής Υποστήριξης της Πρακτικής Άσκησης Φοιτητών (ΑΤΛΑΣ).txt", RichTextBoxStreamType.PlainText);
        }

        private void button10_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Διαδικτυακές Τηλεδιασκέψεις (ePresence).txt", RichTextBoxStreamType.PlainText);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            richTextBox2.LoadFile("textfiles\\Μεταδόσεις Εκδηλώσεων (ΔΙΑΥΛΟΣ).txt", RichTextBoxStreamType.PlainText);
        }
