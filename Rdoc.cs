...
namespace Unipi_Guide
{
    public partial class Rdoc : Form
    {
        ...
        {
            String filename = "FEK-769Β-2018-OIK.pdf";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            String filename1 = "fek_6563-2021.pdf";
            axAcroPDF1.LoadFile(filename1);
        }

        private void button7_Click(object sender, EventArgs e)
        {
            String filename2 = "FEK-1479B-2018-DES.pdf";
            axAcroPDF1.LoadFile(filename2);
        }

        private void button12_Click(object sender, EventArgs e)
        {
            String filename3 = "FEK-940B-2018-TOYR.pdf";
            axAcroPDF1.LoadFile(filename3);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            String filename4 = "FEK-769Β-2018-BIO.pdf";
            axAcroPDF1.LoadFile(filename4);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            String filename5 = "FEK-3954B-2018-NAY.pdf";
            axAcroPDF1.LoadFile(filename5);
        }

        private void button11_Click(object sender, EventArgs e)
        {
            String filename6 = "FEK-729B-2018-STA.pdf";
            axAcroPDF1.LoadFile(filename6);
        }

        private void button8_Click(object sender, EventArgs e)
        {
            String filename7 = "FEK-1005B-2018-XRH.pdf";
            axAcroPDF1.LoadFile(filename7);
        }

        private void button10_Click(object sender, EventArgs e)
        {
            String filename8 = "FEK-2736B-2018-PLH.pdf";
            axAcroPDF1.LoadFile(filename8);
        }

        private void button9_Click(object sender, EventArgs e)
        {
            String filename9 = "FEK-1244B-2018-PSHF.pdf";
            axAcroPDF1.LoadFile(filename9);
        }
