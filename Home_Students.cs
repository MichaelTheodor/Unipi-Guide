...
{
    public partial class Home_Students : Form
    {
        String connectionString = "Data source = database.db;version=3";
        SQLiteConnection conn;
        private SoundPlayer _soundPlayer;
        public Home_Students()
        {
            InitializeComponent();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String evaluation = richTextBox1.Text;
            String selectSQL = "Select * from ΒΑΘΜΟΛΟΓΙΑ_ΣΧΟΛΙΑ";
            SQLiteCommand cmd = new SQLiteCommand(selectSQL, conn);
            SQLiteDataReader reader = cmd.ExecuteReader();
            while (reader.Read())
            {
                richTextBox1.AppendText(Environment.NewLine+"Αξιολόγηση: "+reader.GetString(1)+"   "+"Σχόλια: "+reader.GetString(2)+Environment.NewLine);
            }

            conn.Close();
        }
        private void επιστημονικήΈνωσηΑποφοίτωνΤουΠανεπιστημίουΠειραιώςToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            Submit_comments f100 = new Submit_comments();
            f100.Show();
            this.Close();
        }
        ...
        private void σύγκλητοςToolStripMenuItem_Click(object sender, EventArgs e)
        {
